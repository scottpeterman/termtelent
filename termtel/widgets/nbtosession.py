...
class App(QWidget):
    ...
    def update_theme(self, theme_name: str):
        ...
        self.tokenField.setStyleSheet(line_edit_style)
        self.urlField.setStyleSheet(line_edit_style)
        ...
        # Find the title label and apply style
        for i in range(self.main_frame.content_layout.count()):
            item = self.main_frame.content_layout.itemAt(i)
